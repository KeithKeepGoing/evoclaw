...
**v1.10.23** — **關鍵修復與文檔完善**：
- **Docker 鏡像依賴**：預裝 `libfreetype6`, `libpng16-16`, `zlib1g` 系統庫及 `fonts-wqy-zenhei` 中文字型，修復 PPT/PDF 生成失敗問題。
- **容器鏡像配置**：新增 `CONTAINER_IMAGE` 環境變數支持，可彈性指定 Docker 鏡像版本。
- **文檔系統**：新增 `CHANGELOG.md`, `RELEASE.md`, `ISSUES.md`, `PULL_REQUEST_TEMPLATE.md` 及 GitHub Issue 模板，建立完整的發布流程與問題追蹤機制。
...
> 
> *Last updated by Eve Bot on 2026-03-12 (Test commit for identity verification)*
